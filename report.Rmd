...
user_dat %>% write_tsv(here("results","user-dat_{today()}.tsv"))
```
...
summary_dat_recent %>% write_tsv(here("results","summary-dat-recent_{today()}.tsv"))
...
summary_dat_all %>% write_tsv(here("results","summary-dat-all_{today()}.tsv"))
